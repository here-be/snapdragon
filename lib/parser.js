...
Parser.prototype = {
  ...
  /**
   * Create a new [Node](#node) at the current string `position`,
   * for the given `val` and `type`.
   *
   * ```js
  ...
  parse: function(input) {
    ...
    utils.balanceSets(this, this.stack.pop());
