 ...
 *
 * @param {Compiler} renderer
 * @api public
 */

function mixin(renderer) {
  renderer._comment = renderer.comment;
  renderer.map = new SourceMap();
  renderer.position = { line: 1, column: 1 };
  renderer.files = {};
  for (var k in exports) renderer[k] = exports[k];
}
...
exports.emit = function(str, pos) {
  if (pos) {
    var sourceFile = urix(pos.source || 'string');
    this.map.addMapping({
      source: sourceFile,
      generated: {
